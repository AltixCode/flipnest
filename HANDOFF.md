...
**Flipnest** — flip cards, find the pairs, one themed board a day.
Plan: `/Volumes/ExtremePro/Dev/next_mobile_apps/PLAN_2.md` (PLAN_2.md §5).
...
1. **Write the game.** Nothing of it exists yet — deal, flip/match state machine, theme packs.
   The plan for this app is `next_mobile_apps/PLAN_2.md` (PLAN_2.md §5).
...
3. **Free tier**, as planned: archive last 7 days, theme packs behind the unlock.
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.flipnest` |
| Scheme | `flipnest://` |
| GitHub | `AltixCode/flipnest` |
| RevenueCat project | `proj8e0a4783` |
| RevenueCat iOS app | `app28e035bcb2` |
| RevenueCat Android app | `appc11e371842` |
| Entitlement | `remove_ads` (`entl2abe651615`) |
| Offering / package | `default` (`ofrngadd2569fba`) / `$rc_lifetime` (`pkge5455316c1f`) |
| AdMob app (iOS) | `ca-app-pub-2504845459806550~4240038965` |
| AdMob app (Android) | `ca-app-pub-2504845459806550~6644420039` |
| AdMob banner (iOS / Android) | `ca-app-pub-2504845459806550/4477421696` / `ca-app-pub-2504845459806550/4755044281` |
| AdMob interstitial (iOS / Android) | `ca-app-pub-2504845459806550/5359258520` / `ca-app-pub-2504845459806550/3164340022` |
| AdMob rewarded (iOS / Android) | `ca-app-pub-2504845459806550/7381207621` / `ca-app-pub-2504845459806550/4397530643` |
| App Store app id | `6812275522` |
| App Store name | Flipnest |
| IAP id / product | `6812277478` / `com.altixcode.flipnest.removeads` |

All ten release identifiers plus `EXPO_TOKEN` are already GitHub repo secrets.
Locally they come from `/Volumes/ExtremePro/Dev/mobile_expo_apps/.admob-ids/flipnest.env` —
...
1. **App Store Connect record — done.** App `6812275522` exists, with
   ...
   is **Flipnest**, which may differ from the in-app name: App
...
- Shared code is generated. Fix it in `AltixCode/next-mobile-apps` (`_template/`)
  and re-run `node scripts/bootstrap.mjs flipnest`, never in this copy —
