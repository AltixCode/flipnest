...
/**
 * Store identity and native configuration for Flipnest.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Flipnest works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.flipnest',
    supportsTablet: true,
  ...
  android: {
    package: 'com.altixcode.flipnest',
    adaptiveIcon: {
      backgroundColor: '#140C06',
