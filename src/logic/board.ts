...
export const THEMES: Theme[] = [
  {
    id: 'fruit',
    nameKey: 'themeFruit',
    faces: ['apple', 'pear', 'plum', 'cherry', 'grape', 'lemon', 'peach', 'melon', 'fig', 'kiwi', 'mango', 'berry'],
  },
  {
    id: 'weather',
    nameKey: 'themeWeather',
    faces: ['sun', 'cloud', 'rain', 'snow', 'storm', 'wind', 'fog', 'rainbow', 'hail', 'moon', 'star', 'comet'],
  },
  {
    id: 'garden',
    nameKey: 'themeGarden',
    faces: ['rose', 'tulip', 'daisy', 'fern', 'ivy', 'oak', 'pine', 'moss', 'clover', 'thistle', 'poppy', 'lily'],
  },
  {
    id: 'harbour',
    nameKey: 'themeHarbour',
    faces: ['anchor', 'buoy', 'sail', 'rope', 'shell', 'crab', 'gull', 'lantern', 'net', 'oar', 'wave', 'compass'],
  },
];
